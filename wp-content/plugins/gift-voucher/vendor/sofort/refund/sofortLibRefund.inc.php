 ...
 * Class for refunds
 */
class SofortLibRefund extends SofortLibMultipay {
	...
	public function getReason($i = 0, $reason = 'reason_1') {
		if(!in_array($reason, array('reason_1', 'reason_2'))) return false;
	...
	public function setReason($reason_1, $reason_2 = '') {
		...
		if($reason_2 != '') $this->_parameters['refund'][$this->_refund_count - 1]['reason_2'] = $reason_2;
