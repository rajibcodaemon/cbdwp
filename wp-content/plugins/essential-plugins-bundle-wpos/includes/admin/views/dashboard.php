...
$plugins_data	= espbw_get_plugin_data();
$plugins_filter = espbw_plugins_filter();
	...
	<div class="espbw-dashboard-wrap">
		...
		<div class="espbw-dashboard-title">
			<div class="espbw-dashboard-title-inr">
				<div class="espbw-dashboard-logo"><img src="<?php echo esc_url( ESPBW_URL ); ?>assets/images/essential-plugin-50.png" alt="" /></div>
				<h2><?php _e( 'Essential Plugins Bundle', 'espbw' ); ?></h2>
				<a href="https://www.wponlinesupport.com/?utm_source=wp&utm_medium=plugin&utm_campaign=essential-bundle" target="_blank"><span>By WP OnlineSupport</span></a>
			</div>
		</div>
		<br/>
